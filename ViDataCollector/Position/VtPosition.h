...
struct VtPosition
{
	...
	int TotVolume = 0; //	10	int	전체잔고
	int TodayVol = 0; //	10	int	당일잔고
	int PrevOpenQty = 0; //	10	int	전일잔고
	double Fee = 0.0f; //	15	double	수수료
	double OpenAmt = 0.0f; //	15	double	평가금액
	double TradePL = 0.0f; //	15	double	매매손익
